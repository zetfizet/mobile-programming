...
git push origin master# 1. Pastikan semua file ter-commit di branch lokal (misal: master)
                      git add .
                      git commit -m "Prepare for subtree push"
                      ...
                      git add .
                      git commit -m "Move project to dice-roller folder"
                      git push origin mastergit init
    git remote add origin https://github.com/zetfizet/mobile-programming.git
